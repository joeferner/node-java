...
describe('invalidLaunch', () => {
  test('failedLaunch', () => {
    ...
    expect(() => { java.ensureJvm(); }).toThrow(/requires its one argument to be a callback function/);
  ...
  test('callbackNotAFunction', () => {
    ...
    expect(() => { java.ensureJvm('foo') }).toThrow(/requires its one argument to be a callback function/);
